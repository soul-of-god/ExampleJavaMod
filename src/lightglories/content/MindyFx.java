...
import arc.util.*;
import lightglories.graphics.Pal2;
import mindustry.*;
...
public class MindyFx {
    ...
    starPoof = new Effect(50f, e -> {
        ...
        Draw.rect("lightglories-star", e.x, e.y, Draw.scl * Draw.xscl * e.rotation * (1f + e.fin() * 0.5f), Draw.scl * Draw.yscl * e.rotation * (1f + e.fin() * 0.5f), rot);
    }),
    ...
    starFade = new Effect(30f, e -> {
        ...
        rect("lightglories-star", e.x, e.y, scl * xscl * e.rotation, scl * yscl * e.rotation, rot);
