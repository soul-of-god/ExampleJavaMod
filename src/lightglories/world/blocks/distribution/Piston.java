...
import lightglories.world.blocks.distribution.PistonArm.*;
...
public class Piston extends Block {
    ...
    public void load(){
        ...
        shaftRegion = atlas.find(name + "-shaft", "lightglories-piston-shaft");
        for(int i = 0; i<4; i++){
            baseRegion[i] = atlas.find(baseSprite + "-" + i, "lightglories-piston-" + i);
        }
    }
    ...
    public class PistonBuild extends Building {
        ...
        */
        ...
        public boolean push(){
            ...
            return LightGlories.pushUtil.pushBlock(tile.nearbyBuild(rotation), rotation, maxBlocks, b -> (b != this && pushBool.get(b)), stickBool);
        }
        ...
        public boolean pull(){
            ...
            LightGlories.pushUtil.pushBlock(pullb, (rotation + 2) % 4, maxBlocks, b -> (b != this && pushBool.get(b)), stickBool);
            return true;
        }
        ...
        public void extendArm(){
            ...
            if(extended){
                heatTimer.reset(0, 0);
                LightGlories.pushUtil._pushUnits(this, rotation);
