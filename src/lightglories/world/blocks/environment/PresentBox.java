...
import arc.util.io.*;
import lightglories.content.MindySounds;
...
public class PresentBox extends Block {
    ...
    public void load(){
        super.load();
        baseRegion = atlas.find(name + "-base", "lightglories-present-base");
        boxRegion = atlas.find(name + "-box", "lightglories-present-box");
        topRegion = atlas.find(name + "-top");
        ribbonRegion = atlas.find(name + "-ribbon", "lightglories-present-ribbon");
        ribbonRegionBack = atlas.find(name + "-ribbon-back", "lightglories-present-ribbon-back");
