package lightglories.world.blocks.payloads;
...
public class RBuild {
    ...
    public static RBuild read(Reads read, byte revision){
        return new RBuild(LightGlories.mobileUtil.readPayload(read), read.b(), read.b());
    }

    public static void write(RBuild rp, Writes write){
        LightGlories.mobileUtil.writePayload(rp.pay, write);
        write.b(rp.x);
        write.b(rp.y);
    }
